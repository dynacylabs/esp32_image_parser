...
def main():
    ...
    arg_parser.add_argument('action', choices=['show_partitions', 'dump_partition', 'create_elf','create_elf_from_part', 'dump_nvs'], help='Action to take')
    ...
    if args.action == 'create_elf_from_part' :
        verbose = True
